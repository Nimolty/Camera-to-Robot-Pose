...
#        ).float()
        ...
        # check 
#        print(data_path)
#        print('平移前的3d', keypoints['positions'])
#        print('平移后的3d', keypoint_positions_wrt_cam_as_tensor)
#        print('处理前的2d', keypoints['projections'])
#        print('处理后的2d', kp_projs_net_output_as_tensor)
#        print('trans', trans_gt_as_tensor)
#        print('rot', rot_gt_as_tensor)
#        print(keypoints['idx'])
