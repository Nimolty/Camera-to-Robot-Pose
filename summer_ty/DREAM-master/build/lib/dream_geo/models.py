...
class DreamHourglass(nn.Module):
    def __init__(
        ...
        self.layer_0_2_down = nn.Sequential(*[self._make_stage(64, 128, num_blocks=2)])
        self.layer_0_3_down = nn.Sequential(*[self._make_stage(128, 256, num_blocks=4)])
        self.layer_0_4_down = nn.Sequential(*[self._make_stage(256, 512, num_blocks=4)])
        self.layer_0_5_down = nn.Sequential(*[self._make_stage(512, 512, num_blocks=4)])
        ...
        if self.deconv_decoder:
            ...
            self.upsample_0_4.add_module(
                "4", nn.Conv2d(512+56, 256, kernel_size=3, stride=1, padding=1)
            )
        ...
        # self.mlps_base.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_base.add_module('1',nn.Tanh().cuda())
        # self.mlps_base.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlps_joint_1 = nn.Sequential()
        # self.mlps_joint_1.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_joint_1.add_module('1',nn.Tanh().cuda())
        # self.mlps_joint_1.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlps_joint_2 = nn.Sequential()
        # self.mlps_joint_2.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_joint_2.add_module('1',nn.Tanh().cuda())
        # self.mlps_joint_2.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlps_joint_3 = nn.Sequential()
        # self.mlps_joint_3.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_joint_3.add_module('1',nn.Tanh().cuda())
        # self.mlps_joint_3.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlps_joint_4 = nn.Sequential()
        # self.mlps_joint_4.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_joint_4.add_module('1',nn.Tanh().cuda())
        # self.mlps_joint_4.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlps_joint_5 = nn.Sequential()
        # self.mlps_joint_5.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_joint_5.add_module('1',nn.Tanh().cuda())
        # self.mlps_joint_5.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlps_hand = nn.Sequential()
        # self.mlps_hand.add_module('0', nn.Linear(3, 8).cuda())
        # self.mlps_hand.add_module('1',nn.Tanh().cuda())
        # self.mlps_hand.add_module('2', nn.Linear(8, 16).cuda())

        # self.mlp_link0 = nn.Sequential()
        # self.mlp_link0.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link0.add_module('1', nn.Tanh().cuda())
        # self.mlp_link0.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link1 = nn.Sequential()
        # self.mlp_link1.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link1.add_module('1', nn.Tanh().cuda())
        # self.mlp_link1.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link2 = nn.Sequential()
        # self.mlp_link2.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link2.add_module('1', nn.Tanh().cuda())
        # self.mlp_link2.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link3 = nn.Sequential()
        # self.mlp_link3.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link3.add_module('1', nn.Tanh().cuda())
        # self.mlp_link3.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link4 = nn.Sequential()
        # self.mlp_link4.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link4.add_module('1', nn.Tanh().cuda())
        # self.mlp_link4.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link5 = nn.Sequential()
        # self.mlp_link5.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link5.add_module('1', nn.Tanh().cuda())
        # self.mlp_link5.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link6 = nn.Sequential()
        # self.mlp_link6.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link6.add_module('1', nn.Tanh().cuda())
        # self.mlp_link6.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link7 = nn.Sequential()
        # self.mlp_link7.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link7.add_module('1', nn.Tanh().cuda())
        # self.mlp_link7.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link8 = nn.Sequential()
        # self.mlp_link8.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link8.add_module('1', nn.Tanh().cuda())
        # self.mlp_link8.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link9 = nn.Sequential()
        # self.mlp_link9.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link9.add_module('1', nn.Tanh().cuda())
        # self.mlp_link9.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link10 = nn.Sequential()
        # self.mlp_link10.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link10.add_module('1', nn.Tanh().cuda())
        # self.mlp_link10.add_module('2', nn.Linear(16, 16).cuda())

        # self.mlp_link11 = nn.Sequential()
        # self.mlp_link11.add_module('0', nn.Linear(32, 16).cuda())
        # self.mlp_link11.add_module('1', nn.Tanh().cuda())
        # self.mlp_link11.add_module('2', nn.Linear(16, 16).cuda())
    ...
    def forward(self, x, y = torch.zeros(1,7,3).cuda()):
        ...
        # x3d_feature_16 = x3d_feature.view(-1, 16).unsqueeze(-1).unsqueeze(-1)
        # x3d_feature_16_25_25 = x3d_feature_16.repeat(1,1,25,25)
        # x3d_feature_16_50_50 = x3d_feature_16.repeat(1, 1, 50, 50)
        # x3d_feature_16_100_100 = x3d_feature_16.repeat(1, 1, 100, 100)
        # x3d_feature_16_200_200 = x3d_feature_16.repeat(1, 1, 200, 200)
        ...
        # x_0_1_d = torch.cat((x_0_1_d, x3d_feature_56_200_200), dim=1)
        x_0_2 = self.layer_0_2_down(x_0_1_d)
        x_0_2_d = self.down_sample(x_0_2)
        # x_0_2_d = torch.cat((x_0_2_d, x3d_feature_16_100_100), dim=1)
        x_0_3 = self.layer_0_3_down(x_0_2_d)
        x_0_3_d = self.down_sample(x_0_3)
        # x_0_3_d = torch.cat((x_0_3_d, x3d_feature_16_50_50), dim=1)
        x_0_4 = self.layer_0_4_down(x_0_3_d)
        x_0_4_d = self.down_sample(x_0_4)
        # x_0_4_d = torch.cat((x_0_4_d, x3d_feature_16_25_25), dim=1)
        ...
        if self.skip_connections:
            ...
            decoder_input = x_0_5
        decoder_input = torch.cat((decoder_input, x3d_feature_56_25_25), dim=1)
        # Decoder
        if self.deconv_decoder:
