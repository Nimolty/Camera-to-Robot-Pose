...
def create_belief_map_as_whole(image_resolution, # image_size (width x height)
                               ...
                               hm_disturb = 0.05, # paper中的Lambda_jt
                               lost_disturb=0.1, # lost_disturb对应fn randomly removing detections with probability \lambda_fn
    ...
    for i_point, point in enumerate(pointsBelief):
        ...
        point1[0] = point1[0] + np.random.randn() * hm_disturb * 2 # hm_disturb是原来paper中的\lambda_jt
