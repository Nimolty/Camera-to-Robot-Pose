...
python Dream_ct_inference.py tracking --load_model /root/autodl-tmp/camera_to_robot_pose/Dream_ty/Dream_model/center-dream/tracking/19/ckpt/model_20.pth --pre_hm --track_thresh 0.001 --test_focal_length 633 --gpus 4


python Dream_ct_inference.py tracking --load_model /root/autodl-tmp/camera_to_robot_pose/Dream_ty/Dream_model/center-dream/tracking/19/ckpt/model_40.pth --pre_hm --track_thresh 0.001 --test_focal_length 633 --gpus 4